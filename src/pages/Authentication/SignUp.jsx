...
const SignUp = () => {
    ...
    const { createUser, setUser, updateUser, loginWithGoogle, error, setError } = useContext(AuthContext);
            ...
            <div className="card bg-base-200 w-full max-w-lg shrink-0 shadow-2xl">
                ...
                <form onSubmit={handleRegister} className="card-body">
                    <fieldset className="fieldset">
                        ...
                        <input type="text" name='photoURL' className="input w-full" placeholder="Enter your photo URL" required />
                        ...
                        <p className="validator-hint hidden">
                            Must be more than 6 characters, including number, lowercase, uppercase
                        </p>
                ...
                <p className='font-medium py-3 text-center'>
                    ...
                    <Link className='text-red-500 hover:underline' to='/auth/login'>Login</Link>
                </p>
            </div>
